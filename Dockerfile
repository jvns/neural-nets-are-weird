...
#set CPU_ONLY := 1
RUN apt-get install libboost-tools-dev libboost-atomic-dev libboost-context-dev libboost-coroutine-dev libboost-exception-dev libboost-python-dev
RUN export PYTHONPATH=$PYTHONPATH:/neural-nets/caffe/python
